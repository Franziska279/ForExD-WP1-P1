...
$PYTHON /Net/Groups/BGI/scratch/fmueller/ForExD-WP1-P1/src/09_timeseries_distance_extraction.py $IDS_PATH $REFDM_PATH $MINICUBES_SHAPE_PATH $DISTURBANCE_TYPE
